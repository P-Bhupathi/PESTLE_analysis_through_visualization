...
function updateSelectedDateRange_doughnut(year,id,canvas_id) {
    //console.log(year)
    $('#'+id).val(year)
    time_vs_intensity_of_sector(year,canvas_id)
}
window.updateSelectedDateRange_doughnut = updateSelectedDateRange_doughnut;


// Event for change date of jquery input for INTENSITY_vs_year graph 
function updateSelectedDateYear_doughnut(this_id,range_id,canvas_id) {
    var enteredYear = $('#'+this_id).val();
        ...
        time_vs_intensity_of_sector($('#'+this_id).val(),canvas_id);
}
window.updateSelectedDateYear_doughnut = updateSelectedDateYear_doughnut;